...
return (
    ...
    <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-5 items-center">
            <img
                className="h-full hidden max-2xl:block max-md:hidden   dark:md:block"
                src={ytLogo}
                alt="Youtube"
            />
            <img
    ...
    <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
            <img src="https://lh3.googleusercontent.com/a/AEdFTp65zsS-HZF-y7q6_RveAc6CcWidHzdMKmknTNv8cg=s192-c-rg-br100" />
        </div>
    </div>
</div>
);
